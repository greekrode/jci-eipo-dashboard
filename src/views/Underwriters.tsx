  ...
  return (
    <div className="stagger space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-border bg-card px-4 py-2.5">
        <div className="font-mono text-[15px] uppercase tracking-wider text-muted-foreground">View underwriters as</div>
        <div className="inline-flex overflow-hidden rounded-[2px] border border-border">
          {(["all", "lead", "member"] as const).map((r) => (
            <button
              ...
              onClick={() => pickRole(r)}
              className={cn(
                "border-r border-border px-5 py-2 font-mono text-[15px] uppercase tracking-wider transition-colors last:border-r-0 hover:text-foreground",
        ...
        <CardContent className="p-0">
          <div className="flex flex-wrap items-center gap-2 border-b border-border px-4 py-3">
            <Input
              ...
              className="w-64"
            />
            <span className="tabnum ml-auto font-mono text-[15px] text-muted-foreground">{rows.length} underwriters</span>
          </div>
